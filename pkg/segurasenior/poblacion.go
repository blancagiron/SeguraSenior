...
func NewPoblacion(nom string, poblacion uint32, poblacion_menor_18 uint32, poblacion_entre_18_y_64 uint32, poblacion_mayor_64 uint32,
	tasa_natalidad_sobre_1000 float64, tasa_envejecimiento_sobre_1000 float64, tasa_mortalidad_sobre_1000 float64) (*Datos_poblacion, error) {
	if nom == "" {
	...
	if (tasa_mortalidad_sobre_1000 < 0.0) || (tasa_mortalidad_sobre_1000 > 1000.0) {
	...
	return &Datos_poblacion{
		...
		Tasa_mortalidad:     tasa_mortalidad_sobre_1000,
	}, nil
}
